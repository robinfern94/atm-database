...
-- ATM table inserts
INSERT INTO ATM (atm_id, bank, region, keypad, handprint_scanner, debit, network, police_station, status) VALUES 
(1, 1, 1, 51, 51, 1, 1, 1, 'yes'), 
(2, 2, 2, 52, 52, 2, 2, 2, 'yes'), 
(3, 3, 3, 53, 53, 3, 3, 3, 'yes'),
(4, 4, 4, 54, 54, 4, 2, 4, 'yes'),
(5, 5, 5, 55, 55, 5, 2, 5, 'yes');
